...
const ParentLogin = ({ handleLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    handleLogin({ identifier, password, user_type: 'parent' });
  };
  ...
  return (
    <div className="centered">
      <div className="form-container">
        ...
        <p>If not already an existing parent, please <Link to="/parent-signup">Sign up</Link></p>
