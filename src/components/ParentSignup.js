...
const ParentSignup = ({ handleSignup }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const transformedData = {
        ...
        user_type: 'parent', // Make sure user_type is passed as 'parent'
      };
  ...
  return (
    <div className="signup-container">
      <div className="card form-container">
          ...
          <div className="grid-container">
            ...
            <div className="grid-item">
              ...
              <select
                ...
                required
              >
                <option value="">Select Relationship</option> {/* Default option */}
        ...
        <p>If already an existing parent, please <Link to="/">Login</Link></p>
