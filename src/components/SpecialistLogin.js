...
const SpecialistLogin = ({ handleLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    handleLogin({ identifier, password, user_type: 'specialist' });
  };
  ...
  return (
    <div className="centered">
      <div className="form-container">
        ...
        <p>If not already an existing specialist, please <Link to="/specialist-signup">Sign up</Link></p>
        <p>If you're a pediatrician, please <Link to="/pediatrician-login">Log in</Link></p>
