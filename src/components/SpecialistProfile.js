...
const SpecialistProfile = ({ currentUser, setCurrentUser, handleUpdateProfile }) => {
  const [formData, setFormData] = useState({
    phoneNumber: currentUser.specialist_phone_number || '',
    email: currentUser.specialist_email || '',
    firstName: '',
    lastName: '',
    clinicName: '',
    specialization: '',
  ...
  useEffect(() => {
    if (currentUser) {
      setFormData({
        phoneNumber: currentUser.specialist_phone_number || '',
        email: currentUser.specialist_email || '',
        firstName: currentUser.specialist_first_name || '',
        lastName: currentUser.specialist_last_name || '',
        clinicName: currentUser.specialist_clinic_name || '',
        specialization: currentUser.specialist_specialization || '',
        newPassword: '',
        confirmNewPassword: '',
      });
    }
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const isFormEdited =
      formData.phoneNumber !== currentUser.specialist_phone_number ||
      formData.email !== currentUser.specialist_email ||
      formData.firstName !== currentUser.specialist_first_name ||
      formData.lastName !== currentUser.specialist_last_name ||
      formData.clinicName !== currentUser.specialist_clinic_name ||
      formData.specialization !== currentUser.specialist_specialization;
      ...
      <form onSubmit={handleSubmit} className="centered-form">
        <div className="form-group-grid">
          <div className="form-group">
              <label>
                <span className="bold-label">Phone Number: </span>{currentUser.specialist_phone_number}
              </label>
            </div>
            <div className="form-group">
              <label>
                <span className="bold-label">Email: </span>{currentUser.specialist_email}
              </label>
            </div>
            <div className="form-group">
              <label>
                <span className="bold-label">First Name: </span>{currentUser.specialist_first_name}
              </label>
            </div>
            <div className="form-group">
              <label>
                <span className="bold-label">Last Name: </span>{currentUser.specialist_last_name}
              </label>
            </div>
            <div className="form-group">
              <label>
            ...
            <div className="form-group">
              <label>
                <span className="bold-label">Specialization: </span>{currentUser.specialist_specialization}
              </label>
            </div>
        </div>
